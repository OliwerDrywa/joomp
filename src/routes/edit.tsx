...
function RichRedirectEditor(props: { b: string }) {
  ...
  const compressedBangs = createMemo(() => {
    ...
    return {
      [Compression.None]: compress(str, Compression.None),
      [Compression.Base64]: compress(str, Compression.Base64),
      [Compression.LZString]: compress(str, Compression.LZString),
      [Compression.Gzip]: compress(str, Compression.Gzip),
    } as const;
  });
